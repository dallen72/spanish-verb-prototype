...
export class FirstExcercise {
  ...
  generateConjugationGameElements(verb) {
    ...
    for (let i = 0; i < Object.keys(this.verb.conjugations).length; i++) {
      let conjugation = this.verb.conjugations[Object.keys(this.verb.conjugations)[i]];
      let keyName = this.getKeyByValue(this.verb.conjugations, conjugation);
